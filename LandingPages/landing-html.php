        ...
        <div class="features-grid">
            ...
            <div class="feature-card">
                ...
                <p class="feature-description">
                    Structured sessions with break intervals. 
            ...
            <div class="steps-container">
                <div class="step">
                    ...
                    <p class="step-description">
                        Choose your focus duration and start the Pomodoro timer and break length. 
                    </p>
                </div>
                ...
                <div class="step">
                    ...
                    <p class="step-description">
                        Work on your tasks with full concentration during the focus sessions. 
    ...
    <section class="cta">
        <div class="container">
            ...
            <p class="cta-description">
                Join LockIn today and start building better study habits through structured focus sessions and reflective learning.
            </p>
        ...
        <div class = "container">
            <div class ="footer-content">
                ...
                <div class = "footer-links">
                    ...
                    <div class = "footer-column">
                        <h4>Account</h4>
                        <a href="../LoginAndSignUpPages/login.html">Log In</a>
                        <a href="../LoginAndSignUpPages/signup.html"> Sign Up</a>
                    </div>
            </div>
        </div>
