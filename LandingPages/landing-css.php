...
/* Color scheme : Purple accent matching LockIn brand. */
...
:root{
    /*Colour Palette - Matching signup/login pages*/
    --accent-color: #8672FF;
    --base-color: #FFFFFF;
    --text-color: #000000;
    --input-color:#F3F0FF;
...
.btn-outline-large:hover{
    ...
    box-shadow: rgba(134, 114, 255, 0.1);
    transform: translateY(-2px);
}
...
.visual-card{
    ...
    box-shadow: 0 20px 60px rgba(134,114,255,0.2);
    position: relative;
    overflow: hidden;
    width: 100%;
    max-width: 500px;
...
.feature-card:hover {
    ...
    box-shadow: 0 20px 40px rgba(134, 114, 255, 0.1);
...
.step:hover .step-number {
    transform: scale(1.1);
    box-shadow: 0 8px 16px rgba(134, 114, 255, 0.3);
}
...
.cta-actions .btn-outline-large:hover {
    background: white;
    color: var(--primary-purple);
    transform: translateY(-2px);
